-- AlterTable
ALTER TABLE "alert_history" ADD COLUMN "symbol" TEXT;
...
INSERT INTO "new_hot_entry" ("added_at_utc", "anchor_mcap", "anchor_price", "chain_id", "contract_address", "failsafe_fired", "hot_id", "image_url", "mcap_targets", "name", "pct_target", "socials_json", "symbol", "websites_json") SELECT "added_at_utc", "anchor_mcap", "anchor_price", "chain_id", "contract_address", "failsafe_fired", "hot_id", "image_url", "mcap_targets", "name", "pct_target", "socials_json", "symbol", "websites_json" FROM "hot_entry";
